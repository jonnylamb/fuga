...
AUTH_URL = 'https://www.strava.com/oauth/authorize?client_id=362&response_type=code&redirect_uri=http://fuga.jonnylamb.com&approval_prompt=force&scope=write'
CALLBACK_URL = 'http://fuga.jonnylamb.com/'
